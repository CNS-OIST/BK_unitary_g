...
NEURON {
  ...
  RANGE ica_pmp,ca1,ca2,ca3,ca4,ca5,ca9,C0,C1,C2,C3,C4,O0,O1,O2,O3,O4 
:RANGE pump_0  
...
PROCEDURE rates(v(mV), ca (mM)) { 
    ...
    alpha = exp(Qo*FARADAY*10*v/R/(273.15 + celsius)) : F is based on 10000 coulombs, we need kilocoulomb
    beta  = exp(Qc*FARADAY*10*v/R/(273.15 + celsius)) : F is based on 10000 coulombs, we need kilocoulomb
