...
#define nrn_init _nrn_init__mslo
#define _nrn_initial _nrn_initial__mslo
#define nrn_cur _nrn_cur__mslo
#define _nrn_current _nrn_current__mslo
#define nrn_jacob _nrn_jacob__mslo
#define nrn_state _nrn_state__mslo
#define _net_receive _net_receive__mslo 
#define activation activation__mslo 
#define rates rates__mslo 
...
extern void hoc_reg_nmodl_filename(int, const char*);
 ...
 "setdata_mslo", _hoc_setdata,
 "rates_mslo", _hoc_rates,
 0, 0
};
...
#define k1 k1_mslo
 double k1 = 1000;
#define onoffrate onoffrate_mslo
 double onoffrate = 1;
#define pb4 pb4_mslo
 double pb4 = 0.1257;
#define pb3 pb3_mslo
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_semantics(_mechtype, 4, "cvodeieq");
 	...
 	ivoc_help("help ?1 mslo /Users/iain/GIT/BK_unitary_g/NEURON/simple_model_250pS/mod/mslo.mod\n");
...
/*static int _ode_matsol1(_threadargsproto_);*/
 ...
 static int activation(void*, double*, _threadargsproto_);
...
#if NMODL_TEXT
static const char* nmodl_filename = "/Users/iain/GIT/BK_unitary_g/NEURON/simple_model_250pS/mod/mslo.mod";
static const char* nmodl_file_text = 
  ...
  "\n"
  "Updated for later Cox pub (TODO)\n"
  "\n"
  "ENDCOMMENT\n"
  "\n"
  "NEURON {\n"
