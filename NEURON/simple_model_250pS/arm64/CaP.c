...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_semantics(_mechtype, 4, "cvodeieq");
 	...
 	ivoc_help("help ?1 newCaP /Users/iain/GIT/BK_unitary_g/NEURON/simple_model_250pS/mod/CaP.mod\n");
 ...
 v=_v;
{
  ...
  cao = _ion_cao;
 { error =  states();
 if(error){fprintf(stderr,"at line 75 in file CaP.mod:\n	SOLVE states METHOD cnexp\n"); nrn_complain(_p); abort_run(error);}
 } }}
...
#if NMODL_TEXT
static const char* nmodl_filename = "/Users/iain/GIT/BK_unitary_g/NEURON/simple_model_250pS/mod/CaP.mod";
static const char* nmodl_file_text = 
