...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_semantics(_mechtype, 0, "cvodeieq");
 	...
 	ivoc_help("help ?1 hpkj /Users/iain/GIT/BK_unitary_g/NEURON/simple_model_250pS/mod/ih.mod\n");
...
static int  rates (  double _lv ) {
   ninf = 1.0 / ( 1.0 + exp ( ( _lv + 90.3 + 3.0 + 3.0 ) / 9.67 ) ) ;
   ntau = 1000.0 / ( 0.62 * ( exp ( ( _lv + 68.0 ) / - 22.0 ) + exp ( ( _lv + 68.0 ) / 7.14 ) ) ) / qt / 1.3 ;
    return 0; }
...
{
 { error =  states();
 if(error){fprintf(stderr,"at line 47 in file ih.mod:\n	SOLVE states METHOD cnexp\n"); nrn_complain(_p); abort_run(error);}
 }}}
...
#if NMODL_TEXT
static const char* nmodl_filename = "/Users/iain/GIT/BK_unitary_g/NEURON/simple_model_250pS/mod/ih.mod";
static const char* nmodl_file_text = 
  ": Ih current\n"
  ": Created 8/6/02 - nwg\n"
