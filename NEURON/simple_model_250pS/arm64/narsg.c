...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_semantics(_mechtype, 3, "cvodeieq");
 	...
 	ivoc_help("help ?1 naRsg /Users/iain/GIT/BK_unitary_g/NEURON/simple_model_250pS/mod/narsg.mod\n");
...
#if NMODL_TEXT
static const char* nmodl_filename = "/Users/iain/GIT/BK_unitary_g/NEURON/simple_model_250pS/mod/narsg.mod";
static const char* nmodl_file_text = 
  ...
  "	vshifta = 15 			(mV)                            : steady state activation curve\n"
  "	vshifti = -5             (mV)                            : steady state inactivation curve\n"
  "    vshiftk = 5\n"
  "}\n"
  "\n"
  "ASSIGNED {\n"
  ...
  " ~ O*fip - B*bip = 0 :revised on 02062020\n"
  "\n"
