...
############################################################################
# In the below simulations K_on is set too 200% of original value
############################################################################
...
for BK_fac in BK_facs:
    ...
    with HDF5Handler('./STEPS/data_Kon/'+dataset) as hdf:
...
plt.savefig(f'Figures_Sup/FigureS6.pdf', dpi=300)
plt.close()



############################################################################
# In the below simulations K_on is set too 50% of original value
############################################################################
...
plt.subplots_adjust(wspace=0.4, hspace=0.3)
plt.savefig(f'Figures_Sup/FigureS5.pdf', dpi=300)
plt.close()
